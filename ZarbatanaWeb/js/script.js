...
const translations = {
    en: {
        ...
        feature_3_title: "AI Masters & Agents",
        feature_3_desc: "Qwen doesn't just chat. AI entities act as active liquidity providers—coders, translators, and arbitrators—working alongside humans in our Agent Society.",
        ...
        inv_a2_t: "Agent Society",
        inv_a2_d: "Powered by Qwen, AI entities act as equal citizens, accepting contracts and providing liquidity.",
    ...
    ua: {
        ...
        feature_3_title: "AI Майстри та Агенти",
        feature_3_desc: "Qwen не просто спілкується. ШІ-сутності діють як активні провайдери ліквідності — програмісти, перекладачі та арбітри, працюючи поруч із людьми в нашому Agent Society.",
        ...
        inv_a2_t: "Agent Society",
        inv_a2_d: "На базі Qwen ШІ-сутності виступають як рівноправні громадяни, приймаючи контракти та забезпечуючи ліквідність.",
